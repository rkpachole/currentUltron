...
import { leaveActions, adminUserActions, HoliDayActions } from "../../../../actions";
...
class Index extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            SLeaveData: "",
            selectdate: false,
            filterStatus: [{ value: "", label: "All Status" }],
            filterFromDate: "",
            filterToDate: "",
        ...
        this.employeeChangeHandle =this.employeeChangeHandle.bind(this);
    }
    ...
    openModel(data) {
        ...
        this.setState({
            ...
            activeFrom: "full_day",
            activeto: "full_day",
            formUser: [{ value: this.state.user.data._id, label: this.state.user.data.first_name + " " + this.state.user.data.last_name }],
            // LeaveDaysCount:""
    ...
    openEditModel(data) {
        const { leaveUserList } =this.state;
        var userNameForEdit="";
        var leaveUserList1 = leaveUserList.filter((item)=>item.value == data.userId);
        console.log(leaveUserList1);
        if(leaveUserList1.length)
        {
            userNameForEdit=leaveUserList1[0].label;
        }
    ...
    setReportingList(item) {
        // console.log(item)
        let reportList = []; let leaveUserList=[];
        reportList.push({ value: "", label: "All" });
        ...
        for (var c = 0; c < item.length; c++) {
            ...
            leaveUserList.push({ value: item[c]._id, label: item[c].first_name + " " + item[c].last_name });
        }
        this.setState({
            ReportingList: reportList,
            leaveUserList:leaveUserList
        });
    ...
    employeeChangeHandle(e){
        this.setState({
            formUser: [{ value: e.value, label: e.label }],
            userId:e.value
        });
    }
    ...
    configureSocket = () => {
        ...
        socket.on("leave", data => {
            ...
            else if(this.state.filterReportUser[0].value =="")
            {
                this.getLeavesList();
                this.getCasualLeaveData();
                this.getSickLeaveData();
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.EditList != undefined && this.state.startDate == "") {
            ...
            this.setState({
                ...
                leaveType: nextProps.EditList.leave_type === "unpaid leave" ? { value: "unpaid leave", label: "Unpaid Leave" } : nextProps.EditList.leave_type === "causal leave" ? { value: "casual leave", label: "Casual Leave " } : { value: "sick leave", label: "Sick Leave" },
                                    ...
                                    {LeaveList && LeaveList.map((item, index) => (
                                        <tr key={index}>
                                            ...
                                            <td className="text-right"> 
                                                ...
                                                {this.state.filterReportUser  && item.leaves.status != "reject" &&
                        ...
                        <ModalBody className="modal-body">
                            <div className="my-2">
                                <div className="form-row">
                                    <div className="col">
                                        <div className="form-group">
                                            ...
                                            <Select styles={colourStyles} onChange={this.employeeChangeHandle} value={this.state.formUser} options={this.state.leaveUserList} />
                                ...
                                <div className="form-group">
                                    ...
                                    <div className="form-group select_height">
                            ...
                            <div className="my-2">
                                ...
                                <div className="form-row">
                                    <div className="col">
                                        <div className="form-group">
                                            <label >User<strong className="text-danger" > *</strong></label>
                                            <span> :  {this.state.userNameForEdit}</span>
                                        </div>
                                    </div>
                                </div>
