...
class Index extends Component {
    ...
    getOnLeaveList() {
        this.props.dispatch(dashboardActions.getOnLeaveList({
    ...
    getWorkAnniversaryList() {
        this.props.dispatch(dashboardActions.getWorkAnniversaryList({
            from_date: dateFormat(this.state.work_form_date, "yyyy-mm-dd"),
            to_date: dateFormat(this.state.work_to_date, "yyyy-mm-dd")
        }));
    }
    getBirthdayList() {
        this.props.dispatch(dashboardActions.getBirthdayList(
            {
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.holidaysList != undefined && nextProps.holidaysList != "null"  && nextProps.holidaysList != null) {
            console.log("holidaysList",nextProps.holidaysList);
                            ...
                            <div className="col-lg-4">
                                <div className="card ">
                                    ...
                                    <div className="card-body record_box">
                                        {this.state.onLeaveList && this.state.leaveNorecorde && this.state.onLeaveList.length == 0 ?
                                                        ...
                                                        <div className="carousel-caption">
                                                            <div className="media record_info common_box align-items-center">
                                                                ...
                                                                <div className="media-body">
                                                                    ...
                                                                    <small><strong>{dateFormat(item.from_date, "ddd, dd mmm")} to {dateFormat(item.to_date, "ddd, dd mmm")}</strong></small>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                        ...
                        <div className="row mt-5 dashboard_info_box">
                            <div className="col-lg-4">
                                <div className="card ">
                                    ...
                                    <div className="record_box card-body">
